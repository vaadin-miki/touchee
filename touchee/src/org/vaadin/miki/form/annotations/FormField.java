...
/**
 * Annotates a field in a class that is associated with a login credential field.
 * 
 * @author miki
 *
 */
...
public @interface FormField {
  ...
  /**
   * Identifier of the field. When set to default, name of the field will be used.
   */
  public String identifier() default DEFAULT_FIELD_IDENTIFIER;

  /**
   * Caption of the field. By default it is the same as the field name, with first letter capital.
   */
  public String caption() default DEFAULT_FIELD_CAPTION;

  /**
   * Information about the type of the field, if needed to be passed to the field builder.
   */
  ...
  /**
   * Default caption of the field. Note that it contains a zero-width space, so it is not empty.
   */
