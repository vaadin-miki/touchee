...
public class EditView extends NavigationView {
	...
	private final FieldGroup.CommitHandler commitHandler = new FieldGroup.CommitHandler() {
		...
		public void preCommit(FieldGroup.CommitEvent commitEvent) throws FieldGroup.CommitException {
			broadcastEvent(commitEvent.getFieldBinder(), beforeChangeListeners, false);
		}

		@Override
		public void postCommit(FieldGroup.CommitEvent commitEvent) throws FieldGroup.CommitException {
			broadcastEvent(commitEvent.getFieldBinder(), afterChangeListeners, true);
		}
	};
	...
	public EditView() {
		...
		toolbar.addComponent(this.commit);
		toolbar.addComponent(this.cancel);
		toolbar.setSizeFull();
